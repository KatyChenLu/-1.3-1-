  ...
  <view class="template-preferred tn-safe-area-inset-bottom">
	...
	<view class="" :style="{paddingTop: vuex_custom_bar_height + 'px'}">
	  <swiper class="card-swiper tn-margin-top-sm" :circular="true"
	    ...
	    <swiper-item v-for="(item,index) in swiperList" :key="index" :class="cardCur==index?'cur':''" @click="hpicto(item)">
	  ...
	  <view class="tn-flex tn-flex-row-between tn-flex-col-center tn-margin" >
	    <view class="justify-content-item align-content-item">
	      <view class="tn-bg-gray--light tn-flex tn-flex-col-center" style="border-radius: 100rpx;padding: 10rpx 20rpx 10rpx 20rpx;width: 100%;">
	        ...
	        <input class="justify-content-item" placeholder="输入活动ID号或名称" v-model="searchKey" placeholder-style="color:#AAAAAA" ></input>
	      </view>
	    </view>
  ...
  // 关闭压屏窗
	  ...
	  hpicto(item) {
	  	...
	  	if (item.url&&item.leixing==2) {
	  		this.navigateToFn({ url: '/minePages/chat/room?id='+item.url, checkLogin: true })
	  	}
