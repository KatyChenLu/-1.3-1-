						...
						<view class="tn-flex tn-flex-row-center tn-flex-col-center">
							...
							<view class="tn-flex tn-flex-row-center tn-flex-col-center">
								<view class="tn-padding-right ">
									...
									<view class="tn-padding-right clamp-text-2 tn-padding-left-sm tn-color-gray">
										<text class=" ">
										{{ item.title_sub }}
										</text>
									</view>
...
<view class="tn-fab-class tn-fab"  @click="navigateToFn({ url: '/circlePages/build', checkLogin: true })">
	<view  class="tn-fab__box tn-fab--right" style="left: auto; right: 20px; bottom: 100px; z-index: 19060;">
		<view data-v-710e8188="" class="tn-fab__item__btn tn-fab__item__btn--fab" style="width: 44px; height: 44px; background-color: rgb(1, 190, 255); color: rgb(255, 255, 255); border-radius: 50%; z-index: 19059;">
	<view class="tn-fab__item__btn__icon tn-icon-add" style="font-size: 30px;">
