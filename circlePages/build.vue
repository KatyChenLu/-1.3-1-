<template>
	<view class="template-create tn-safe-area-inset-bottom">
		...
		<view class="tn-flex tn-flex-row-between tn-flex-col-center  tn-margin ">
			...
			圈子分类<text class="tn-color-red">*</text>
			</view>
			<view class="tn-bg-gray--light tn-padding tn-margin">
							
								<view class="tn-color-black" >
								<tn-radio-group @change="getgameid">
									<tn-radio :name="item.id" v-for="(item,indexhuati) in cate" :key="indexhuati">{{item.title}}</tn-radio>
								</tn-radio-group>
								</view>
								
							</view>
			<view class=" tn-text-bold  clamp-text-1 tn-text-justify tn-margin ">
			圈子封面<text class="tn-color-red">*</text>
			</view>
			<view class="tn-margin-left tn-padding-top-xs" style="height: 120px;">
			...
			<view class=" tn-text-bold  clamp-text-1 tn-text-justify tn-margin ">
			付费圈子<text class="tn-color-red">*</text>
			</view>
			<view class="tn-margin tn-bg-gray--light" style="border-radius: 10rpx;padding: 20rpx 30rpx;">
				<input type="number" placeholder="免费请填写0" name="input" maxlength="10" v-model="price" placeholder-style="color:#AAAAAA"></input>
			</view>
