...
function uploadFileToTencentClound(filename, filePath, config) {
  var Bucket = config.Bucket; //存储桶的名称，命名规则为 BucketName-APPID，此处填写的存储桶名称必须为此格式
  var Region = config.Region; //存储桶所在地域
  //创建一个 COS SDK 实例
...
var _default = {
  uploadFileToTencentClound: uploadFileToTencentClound
};
...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return (/******/function (modules) {
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      }, _defineProperty(_defaultOptions, "ChunkRetryTimes", 3), _defineProperty(_defaultOptions, "ChunkSize", 1024 * 1024), _defineProperty(_defaultOptions, "SliceSize", 1024 * 1024), _defineProperty(_defaultOptions, "CopyChunkParallelLimit", 20), _defineProperty(_defaultOptions, "CopyChunkSize", 1024 * 1024 * 10), _defineProperty(_defaultOptions, "CopySliceSize", 1024 * 1024 * 10), _defineProperty(_defaultOptions, "MaxPartNumber", 10000), _defineProperty(_defaultOptions, "ProgressInterval", 1000), _defineProperty(_defaultOptions, "UploadQueueSize", 10000), _defineProperty(_defaultOptions, "Domain", ''), _defineProperty(_defaultOptions, "ServiceDomain", ''), _defineProperty(_defaultOptions, "Protocol", ''), _defineProperty(_defaultOptions, "CompatibilityMode", false), _defineProperty(_defaultOptions, "ForcePathStyle", false), _defineProperty(_defaultOptions, "CorrectClockSkew", true), _defineProperty(_defaultOptions, "SystemClockOffset", 0), _defaultOptions);
      ...
      var initTask = function initTask(cos) {
        ...
        var clearQueue = function clearQueue() {
          if (queue.length > cos.options.UploadQueueSize) {
            var i;
            for (i = 0; i < queue.length && queue.length > cos.options.UploadQueueSize &&
            // 大于队列才处理
            i < nextUploadIndex;
            // 小于当前操作的 index 才处理
            i++) {
...
//# sourceMappingURL=../../../.sourcemap/mp-weixin/circlePages/common/vendor.js.map