		...
		z-index: 99;">
			...
			<view class=" footerfixed">
				<view class="tn-text-center">
					<tn-tabs :list="scrollList" :itemWidth="50" :activeItemStyle="activeItemStyle" :current="current"
						@change="tabChange" :isScroll="false" activeColor="#0C0F42" :bold="true" :fontSize="28"
						bgColor="transparent">
					</tn-tabs>
				</view>
						...
						<view class="tn-flex tn-flex-col-center tn-flex-row-left">
							<view class="logo-pic ">
								<view class="logo-image">
									<tn-avatar  :src="item.avatar" size="lg" shape="square" style="width: 161rpx;height: 164rpx;">
									</tn-avatar>
								</view>
							</view>
							<view class="tn-padding-right tn-color-black">
								...
								<view
									...
									<text class="tn-color-gray tn-text-sm tn-margin-left tn-text-ellipsis"
										v-if="item.city"> {{item.city}}人</text>
								</view>
							</view>
						</view>
					</view>
