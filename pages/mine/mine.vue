					...
					<view class="justify-content-item" style="width: 100%;">
						<view class="tn-flex tn-flex-col-center tn-flex-row-left" style="width: 100%;">
							...
							<view class="" style="width:100%;">
								<view class="tn-padding-right tn-padding-left-sm tn-text-xl tn-text-bold tn-text-justify">
								...
								<view class="tn-padding-right tn-padding-top-xs tn-padding-left-sm tn-text-ellipsis">
									<text class="" style="font-size:12px;">ID号:{{body.id}}
									</text>
									<tn-tag @click="navigateToFn({ url: '/minePages/edit', checkLogin: true })" shape="circle" backgroundColor="tn-cool-bg-color-15" margin="10rpx" width="190rpx">
									<text class="tn-icon-edit" style="font-size:30rpx;"></text>编辑资料
									</tn-tag>
								</view>
								<view class="tn-padding-right  tn-padding-left-sm tn-text-ellipsis">
								<tn-line-progress :height="10"  :percent="baifenbi" :striped="true"></tn-line-progress>
								</view>
								<view class="tn-padding-right  tn-padding-left-sm tn-text-ellipsis">
									<text class="" style="font-size:12px;">Lv <text class="tn-text-bold" style="font-size: 14px;margin-left: 1px;">{{body.lv}}</text>
									</text>
									<text class="" style="font-size:12px; margin-left: 10px;">还差{{chajifen}}积分升级
									</text>
					...
					<view class="tn-flex-1 tn-padding-sm tn-margin-xs" @click="tofans('follow')">
						<view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
							...
							<view class="tn-margin-top-xs tn-color-gray tn-text-df tn-text-center">
								<text class="tn-padding-left-xs " style="font-size: 12px;">我关注的</text>
							</view>
						</view>
					</view>
					<view class="tn-flex-1 tn-padding-sm tn-margin-xs" @click="tofans('fans')">
						<view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
							...
							<view class="tn-margin-top-xs tn-color-gray tn-text-df tn-text-center">
								...
								<text class="tn-padding-left-xs " style="font-size: 12px;">我的粉丝</text>
							</view>
						</view>
					</view>
					<view class="tn-flex-1 tn-padding-sm tn-margin-xs" @click="navigateToFn({ url: '/minePages/my_msg?type=1&title=我的获赞', checkLogin: true })">
						<view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
							<view class="">
								<view class="tn-text-xl ">{{body.zhan}}</view>
							</view>
							<view class="tn-margin-top-xs tn-color-gray tn-text-df tn-text-center">
								<text class="" style="font-size: 12px;">我的获赞</text>
							</view>
						</view>
					</view>
				</view>
...
<!-- 更多信息-->
			<view class="tn-info__container tn-flex tn-flex-wrap tn-flex-col-center tn-flex-row-between tn-margin-left-sm tn-margin-right-sm ">
			...
			<!-- 帖子列表 -->
	<view class="tn-info__container tn-flex tn-flex-wrap tn-flex-col-center tn-flex-row-between tn-margin-left-sm tn-margin-right-sm " v-if="body.is_paly">
			  <!-- #ifdef H5||MP -->
			  <tn-list-cell :hover="true" :unlined="true" :radius="true" :fontSize="30" >
			    <view class="tn-flex tn-flex-col-center">
			    
			      <view class="tn-margin-left-sm tn-flex-1">小程序下单通知
			  	<tn-tag @click="tongzhi()" shape="circle" backgroundColor="tn-cool-bg-color-2" margin="10rpx" width="120rpx">
			   ...
			   <!-- #endif -->
			    <view @click="navigateToFn({ url: '/gamePages/my_goods', checkLogin: true })" class="tn-info__item tn-flex tn-flex-direction-row tn-flex-col-center tn-flex-row-between job-shadow tn-bg-white">
			      <view class="tn-info__item__left tn-flex tn-flex-direction-row tn-flex-col-center tn-flex-row-left">
			      
			        <view class="tn-info__item__left__content">
			          <view class="tn-info__item__left__content--title tn-text-bold">我的收入</view>
			          <view class="tn-info__item__left__content--data tn-padding-top-xs">{{body.gift_money}}</view>
			        </view>
			      </view>
			      <view class="tn-info__item__right">
			        <view class="tn-info__item__right--icon">
			...
			<view @click="navigateToFn({ url: '/gamePages/my_goods', checkLogin: true })" class="tn-info__item tn-flex tn-flex-direction-row tn-flex-col-center tn-flex-row-between job-shadow tn-bg-white">
			  <view class="tn-info__item__left tn-flex tn-flex-direction-row tn-flex-col-center tn-flex-row-left">
			    ...
			    <view class="tn-info__item__left__content">
			      ...
			      <view class="tn-info__item__left__content--data tn-padding-top-xs">{{body.goods_game_num}}个</view>
			    </view>
			  </view>
			  <view class="tn-info__item__right">
			    <view class="tn-info__item__right--icon">
			...
			<!-- 更多信息-->
				...
				<!-- 更多信息-->
				<view class="about-shadow tn-margin-top-xl   tn-bg-white">
					<!-- 方式12 start-->
						...
						<view class="tn-padding-sm tn-margin-xs tn-radius"
							...
							<view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
								<view
									...
									<view class="tn-icon-coupon-fill" style="color: #080808;"></view>
								</view>
					...
					<tn-list-cell :hover="true" :unlined="true" :radius="true" :fontSize="30" @click="navigateToFn({ url: '/minePages/chat/talkkefu?toid=1&toname=官方客服', checkLogin: true })" >
					  <view class="tn-flex tn-flex-col-center">
					    <view
					...
					<tn-list-cell :hover="true" :unlined="true" :radius="true" :fontSize="30" @click="navigateToFn({ url: '/minePages/share', checkLogin: true })" >
					  <view class="tn-flex tn-flex-col-center">
					    <view
					...
					<tn-list-cell :hover="true" :unlined="true" :radius="true" :fontSize="30" @click="navigateToFn({ url: '/gamePages/team_index', checkLogin: true })" >
					  <view class="tn-flex tn-flex-col-center">
					    <view
			...
			<view class="custom-modal-content tn-padding-sm ">
				<view class="  tn-margin-top  ">
					...
					<view class=" tn-flex tn-flex-row-left " style="margin-top:20rpx;">
						<text
							class="tn-padding-xs">申请服务类目，提交相关资料，后台审核后方可发布具体的服务产品</text>
					</view>
				
				</view>

			<view class="tn-flex tn-flex-row-center tn-radius tn-margin-top">
				<tn-button @click="navigateToFn({ url: '/gamePages/shenqing?type=0', checkLogin: false })" shape="round" backgroundColor="tn-main-gradient-bluepurple--reverse"
					padding="40rpx 30rpx" fontBold style="margin-right: 10px;">
					申请线上
				</tn-button>
				<tn-button @click="navigateToFn({ url: '/gamePages/shenqing?type=1', checkLogin: false })" shape="round" backgroundColor="tn-cool-bg-color-5"
					padding="40rpx 30rpx" fontBold style="margin-right: 10px;">
					申请线下
				</tn-button>
		</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			jinru(item){				
			this.navigateToFn({ url: item.url, checkLogin: item.login })	
			},
			refreshFn() {
				this.infobody()
			},
		...
		/// 列表调用
			myhome() {				
				this.navigateToFn({ url: '/circlePages/blogger_other?id='+uni.getStorageSync('user_id'), checkLogin: true })
			},
