<template>
	<view>	
	<tn-nav-bar :isBack="false" :bottomShadow="false" >
	动态
	</tn-nav-bar>
	
  	<mescroll-body ref="mescrollRef" @down="downCallback" @up="upCallback" >
	<view class="tn-flex tn-flex-direction-column tn-margin-bottom" :style="{paddingTop: vuex_custom_bar_height + 'px'}">
					<view class="tn-flex tn-flex-row-between tn-margin-sm">
						<view class="" style="width: 100%;">
							<tn-tabs-swiper class="" ref="tabs" :bold="true" activeColor="#000000"
								inactiveColor="#8b8b8b" :list="list" :fontSize="30" :current="currenttiezi"
								:isScroll="false" @change="tabsChange"></tn-tabs-swiper>
						</view>
					</view>	
	...
	<view class="tn-fab-class tn-fab"
		@click="navigateToFn({ url: '/circlePages/edit', checkLogin: true })">
