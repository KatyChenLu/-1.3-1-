<template>
  ...
  <view
    v-if="visibleSync"
    class="tn-popup-class tn-popup lottery-popup"
 ...
 <view
     ...
     @tap.stop.prevent
   >
  <sanshui-fireworks />	</sanshui-fireworks>
     <view type="center"  class="lottery-popup">
		 
     			<view class="lotterying-title">
     			{{giftitle}}
     			</view>
     			<image src="@/static/bead.png" mode="" class="lotterying-head">
     			</image>
     			<view class="lotterying">
					<view class="tn-text-center" style="padding:0 50px;" v-if="giftimg" >
					<image  :animation="baoxiangmone" mode="heightFix" style="height:150px;width:100%;" :src="giftimg">
					</image>
					</view>
					
     				<view class="lotterying-prize-winner tn-padding-top" v-if="gifcontent">					
     				{{gifcontent}}					
     				</view>						
     			</view>
     		</view>
...
<script>
  import componentsColorMixin from '../../tuniao-ui/libs/mixin/components_color.js'
  export default {
...
<style lang="scss" scoped>
  ...
  .lottery-popup{
  	.lotterying-title {
  		...
  		color: #FFFFFF;
  		line-height: 32upx;
  		text-shadow: 0px 2upx 2upx rgba(224, 99, 35, 0.5);
  	}
  	.lotterying-head {
  		width: 408upx;
  		height: 93upx;
